...
const TArray<FExoLocationNames::FNamedRegion>& FExoLocationNames::GetRegions()
{
	static TArray<FNamedRegion> Regions = {
		...
		// Cardinal compounds
		{TEXT("INDUSTRIAL DISTRICT"), FVector(0.f, 80000.f, 0.f), 18000.f},
		{TEXT("RESEARCH LABS"), FVector(0.f, -80000.f, 0.f), 16000.f},
		{TEXT("POWER STATION"), FVector(80000.f, 0.f, 0.f), 16000.f},
		{TEXT("BARRACKS"), FVector(-80000.f, 0.f, 0.f), 18000.f},
		// Corner outposts
		{TEXT("OUTPOST ALPHA"), FVector(120000.f, 120000.f, 0.f), 10000.f},
		{TEXT("OUTPOST BRAVO"), FVector(-120000.f, 120000.f, 0.f), 10000.f},
		{TEXT("OUTPOST CHARLIE"), FVector(120000.f, -120000.f, 0.f), 10000.f},
		{TEXT("OUTPOST DELTA"), FVector(-120000.f, -120000.f, 0.f), 10000.f},
		// Scattered landmarks
		{TEXT("CROSSROADS"), FVector(40000.f, 40000.f, 0.f), 8000.f},
		{TEXT("THE RUINS"), FVector(-50000.f, 50000.f, 0.f), 8000.f},
		{TEXT("SCRAPYARD"), FVector(60000.f, -40000.f, 0.f), 8000.f},
		{TEXT("DARK HOLLOW"), FVector(-30000.f, -50000.f, 0.f), 8000.f},
		{TEXT("WATCHTOWER"), FVector(20000.f, -70000.f, 0.f), 8000.f},
		{TEXT("RELAY STATION"), FVector(-70000.f, -20000.f, 0.f), 8000.f},
		{TEXT("OVERLOOK"), FVector(50000.f, 70000.f, 0.f), 8000.f},
		{TEXT("SIGNAL POINT"), FVector(-100000.f, -80000.f, 0.f), 8000.f},
		{TEXT("CITADEL"), FVector(90000.f, 50000.f, 0.f), 8000.f},
		{TEXT("NORTHERN RIDGE"), FVector(-20000.f, 120000.f, 0.f), 9000.f},
	};
	return Regions;
}
